...
public class BatCell extends AbstractCell {
    ...
    public String processPlayer(Player player, Maze maze) {
        ...
        if (random.nextDouble() < POSSIBILITY) {
            ...
            return "Whoa -- you successfully duck superbats that try to grab you";
        } else {
            ...
            String moveResult = maze.movePlayerToRandomRoom();
            return "Snatch -- you are grabbed by superbats and ... \n" + moveResult;
        }
    }
}
